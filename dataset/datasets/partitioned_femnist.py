...
from dataset.utils.partition import FMNISTPartitioner


class PartitionedFMNIST(FedDataset):
    ...
    def __init__(self,
        ...
        # image
        self.trainDatasets = torchvision.datasets.FashionMNIST(root=self.root,
                                                               train=True,
                                                               download=download)
        self.testDatasets = torchvision.datasets.FashionMNIST(root=self.root,
    ...
    def preprocess(self,
        ...
        self.partitioner = FMNISTPartitioner(self.trainDatasets.targets,
                                            self.numClients,
                                            partition=partition,
